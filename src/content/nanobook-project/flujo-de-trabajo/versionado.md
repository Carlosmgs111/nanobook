...
Este roadmap de versiones está alineado con el [roadmap detallado](../meta/roadmap) del proyecto. Cada versión agrupa un conjunto de metas; el detalle de tareas se encuentra en los documentos de cada horizonte.

| Versión | Estado | Enfoque | Fases del roadmap vinculadas |
|---|---|---|---|
| `v0.1.0` | En desarrollo | Alpha funcional: navegación principal, sidebar/TOC, tema claro/oscuro, build estable y estructura de contenido inicial. | [Fase 0 — Alpha](../meta/roadmap/fase-0-alpha) |
| `v0.2.0` | Pendiente | Cierre de alpha: TOC activo con resaltado, responsive mobile, accesibilidad básica, ordenamiento consistente e internacionalización inicial. | [Corto plazo](../meta/roadmap/corto-plazo) |
| `v0.3.0` | Pendiente | Producto mínimo consolidado: editor integrado, modos de despliegue estático/dinámico, búsqueda y filtros por tag. | [Medio plazo](../meta/roadmap/medio-plazo) |
| `v0.4.0` | Pendiente | Pulido y contenido real: UX/UI refinada, tipografía, animaciones, contenido propio y feeds. | Resto de [medio plazo](../meta/roadmap/medio-plazo) |
| `v1.0.0` | Pendiente | Release público: URLs estables, documentación completa, responsive sólido y modelo de licenciamiento definido. | [Largo plazo](../meta/roadmap/largo-plazo) |

### Criterios de cambio de versión

- Se incrementa `PATCH` (`0.0.x`) para correcciones menores o parches.
- Se incrementa `MINOR` (`0.x.0`) para nuevas funcionalidades, mejoras significativas de UX o refactorizaciones visibles.
- Se alcanzará `MAJOR 1.0.0` cuando la estructura de contenido, URLs y componentes públicos se consideren estables.
...
- [Roadmap detallado](../meta/roadmap) — plan de desarrollo por fases y horizontes.
