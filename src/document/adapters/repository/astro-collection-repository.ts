import { getAstroEntries } from "../cache/astro-cache";
import type { ContentRepository, Document } from "../../model/types";
import { mkdir, readFile, writeFile } from "node:fs/promises";
import { dirname } from "node:path";
import { idToFilePath } from "../../parse/path";
import { resolveProxy } from "../../parse/proxy";
import { toDocument } from "../../parse/document";
import { CompositeReferenceResolver } from "../../reference/resolver";
import { InternalReferenceResolver } from "../reference/internal-resolver";
import { LocalFileReferenceResolver } from "../reference/local-file-resolver";
import { GitHubReferenceResolver } from "../reference/github-resolver";
