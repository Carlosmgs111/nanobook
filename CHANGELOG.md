...
- Tipos y utilidades de `SiteManifest` en `src/core/publishing/types.ts` y `src/core/publishing/manifest.ts`.
- Documentación de publisher y manifest en `src/content/nanobook-project/arquitectura/publisher-manifest.md`.
