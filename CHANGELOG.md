...
- `MarkdownRenderClient` vuelve al modelo original de IDs de petición (`crypto.randomUUID()`) y un `Map` de promesas pendientes, eliminando la cancelación por terminación del worker que perdía respuestas y dejaba el preview sin actualizar.
